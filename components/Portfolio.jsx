      ...
      <main id="top">
        ...
        <section className="section section-shell about-grid" id="about">
          ...
          <div className="about-copy">
            ...
            <p>
              I care about the details that make a frontend feel professional:
              spacing, hierarchy, responsive behavior, clear states and
              interactions that are easy to understand.
            </p>
        ...
        <section className="section section-shell experience-grid" id="experience">
          <SectionHeading
            ...
            title="Hands-on frontend practice."
          />
        ...
        <section className="section projects-section" id="projects">
          <div className="section-shell">
            <SectionHeading
              ...
              title="Projects built around real frontend skills."
              copy="A focused selection is stronger than filling the portfolio with every learning assignment."
            />
                  ...
                  <div className="project-copy">
                    ...
                    {project.note && (
                      <p className="project-note">
                        <strong>Portfolio accuracy:</strong> {project.note}
                      </p>
                    )}
                  </div>
                </article>
            ...
            <div className="github-more">
              <div>
                <Github size={23} />
                <div>
                  <strong>More learning work lives on GitHub.</strong>
                  <span>
                    Smaller university and practice projects stay there so this
                    portfolio remains focused.
                  </span>
                </div>
              </div>
        ...
        <section className="section section-shell credentials" id="education">
          <div>
            <SectionHeading eyebrow="05 · EDUCATION" title="Background." />
          ...
          <div>
            <SectionHeading eyebrow="CERTIFICATES" title="Additional learning." />
            <div className="credential-list">
        ...
        <section className="contact-section" id="contact">
          <div className="section-shell contact-inner">
            ...
            <span>
              I&apos;m open to Frontend Developer opportunities where I can
              continue building responsive, user-focused web experiences.
            </span>
